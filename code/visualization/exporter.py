...
class Exporter:
    ...
    def __init__(self, output_info: dict) -> None:
        ...
        self.output_directory, self.output_base_name = self.get_destination_components(self.algorithm,
                                                                                       self.district_num,
                                                                                       self.path_method,
                                                                                       self.file_name)
    ...
    def get_destination(self) -> str:
        ...
        if os.path.exists(destination_parent) is False:
    ...
    def make_json(self, lowest_cost, district_num, lowest_batteries):
        ...
        for battery in lowest_batteries.get_members():
            battery_dict = {"location": f'{battery.position[0]}, {battery.position[1]}',
                            "capacity": battery.capacity, "houses": []}
